            ...
            return (
              <div key={semNum} className="space-y-4">
                <button
                  ...
                  className={`w-full p-8 rounded-[2.5rem] border-2 transition-all flex items-center justify-between group ${isExpanded
                ...
                >
                  <div className="flex items-center gap-6">
                    <div className={`w-14 h-14 rounded-2xl flex items-center justify-center font-black text-xl transition-all ${isComplete
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pl-4 animate-in slide-in-from-top-4 duration-300">
                    {semSubjects.length === 0 ? (
                      ...
                      semSubjects.map(subj => {
                        ...
                        return (
                          <div key={subj.id} className={`bg-slate-900 border rounded-[2rem] overflow-hidden group/subj transition-all ${isSubjComplete ? 'border-emerald-500/20' : 'border-slate-800 hover:border-indigo-500/20'
                            }`}>
                            <button
                            ...
                            >
                              <div className="flex items-center gap-4 min-w-0">
                                <div className={`w-1.5 h-10 rounded-full transition-all group-hover/subj:h-12 ${isSubjComplete ? 'bg-emerald-500' : 'bg-indigo-500'
                                  }`}></div>
