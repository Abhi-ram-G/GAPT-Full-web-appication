...
import { UserRole, Feature, AccessLevel, PermissionMap } from '../types';
...
const FEATURE_LABEL_MAP: Record<string, string> = {
   ...
   [Feature.CHAT]: 'CHAT HUB',
   [Feature.EMAIL]: 'MAIL CENTER',
   [Feature.SPREADSHEET]: 'INSTITUTIONAL SHEETS',
   [Feature.EDIT_PROFILE]: 'EDIT PROFILE'
};
...
const ManageAccess: React.FC = () => {
   ...
   const handleUpdateLevel = async (role: UserRole, feature: Feature, level: AccessLevel) => {
      ...
      const updatedPerms = await ApiService.getPermissions();
