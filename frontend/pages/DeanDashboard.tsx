...
const DeanDashboard: React.FC = () => {
   ...
   const stats = useMemo(() => {
      const faculty = users.filter(u => [UserRole.STAFF, UserRole.HOD].includes(u.role));
   ...
   const filteredFaculty = useMemo(() => {
      const faculty = users.filter(u => [UserRole.STAFF, UserRole.HOD, UserRole.DEAN].includes(u.role));
